...
from dataloader.utils import get_imgs, read_from_dicom
...
class CheXpertImageDataset(BaseImageDataset):
    def __init__(self, split="train", transform=None,
                 img_type="Frontal", data_pct=0.01, imsize=256,sentence_split=None):
...
class RSNAImageDataset(BaseImageDataset):
    def __init__(self, split="train", transform=None,
                 phase="classification", data_pct=0.01, imsize=256,sentence_split=None) -> None:
        super().__init__(split=split, transform=transform)
...
class COVIDXImageDataset(BaseImageDataset):
    def __init__(self, split="train", transform=None,
                 data_pct=0.01, imsize=256,sentence_split=None) -> None:
        super().__init__(split=split, transform=transform)
